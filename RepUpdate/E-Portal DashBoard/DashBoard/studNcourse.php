        	...
        	<div>
        		<center>
        			...
        			<a href="" target="_blank">
        				<img class="img-fluid" src="StudStyle/img/logo1.png">
        			</a>
        		</center>
        	</div>
        </li>
			                    ...
			                    <div class="filters-content">
			                        <div class="row grid">
			                            <div class="single-portfolio col-sm-4 all cs">
											...
											<div class="p-inner">
											    <h5>Phython</h5>
												<div class="cat">Computer Science</div>
											</div>					                               
			                            </div>
			                            <div class="single-portfolio col-sm-4 all cs">
			                            	<div class="relative">
			                            ...
			                            <div class="single-portfolio col-sm-4 all man">
			                            	<div class="relative">
				                            	<div class="thumb">
				                            		<div class="overlay overlay-bg"></div>
				                            		<center><img class="image img-fluid" src="StudStyle/img/p1.png" alt=""></center>
			                            ...
			                            <div class="single-portfolio col-sm-4 all psy">
			                            	<div class="relative">
				                            	<div class="thumb">
				                            		<div class="overlay overlay-bg"></div>
				                            		<center><img class="image img-fluid" src="StudStyle/img/p1.png" alt=""></center>
											...
											<div class="p-inner">
											    <h5>Changing Customer Behavior</h5>
												<div class="cat">Psychology</div>
											</div>					                               
			                            </div>
			                            <div class="single-portfolio col-sm-4 all psy">
			                            	<div class="relative">
			                            ...
			                            <div class="single-portfolio col-sm-4 all ls">
			                            	<div class="relative">
				                            	<div class="thumb">
				                            		<div class="overlay overlay-bg"></div>
				                            		 <center> <img class="image img-fluid" src="StudStyle/img/p1.png" alt=""></center>
											...
											<div class="p-inner">
												...
												<div class="cat">Life Science</div>
											</div>					                               
			                            </div>                            
			                            <div class="single-portfolio col-sm-4 all ls">
			                            	<div class="relative">
			                                ...
			                                <div class="p-inner">
			                                    <h5>Cellular Biology and Anatomical Sciences</h5>
			                                    <div class="cat">Life Science</div>
			                                </div>
			                            </div>
