			...
			<div class="container" >
				<div class="row">
						...
						<div class="vertical-item content-absolute">
							<div class="item-media">
								<form method = "post" enctype = "multipart/form-data">
									...
									if($img == "")
									{
										echo "<div><label for ='filebtn'><img src= 'images/team/01.png' alt='No image' ></img></label><p>Click image to upload photo</p></div>";
									}
									else
									{
										echo "<div><label for ='filebtn'><img src= '$img' alt='No image'></img></label><p>Click image to upload photo</p></div>";
									}
					...
					<div class="col-md-7" >
						...
						$sql=mysqli_query($con,"select courses.course_name,result.week,result.score from courses,enroll,result where result.enroll_code = enroll.enroll_code and enroll.course_code = courses.course_code and enroll.reg_no = '$regno' ");
						...
						<div class="tab-content big-padding top-color-border bottommargin_60" style="color: white;">
							...
							<div class="tab-pane fade" id="tab2">
								...
								{ 
									...
									<p class="progress-bar-title">
										<?php echo $cn[$i]."&nbsp;&nbsp;&nbsp;week".$week[$i]; ?>
									</p>
									<div class="progress">
										<div class="progress-bar" role="progressbar" data-transitiongoal="<?php echo $score[$i];?>">
											<span><?php echo $score[$i];?></span>
										</div>
									</div>
							...
							<div class="tab-pane fade" id="tab3">
								<form  method="post">
									...
									<input type="text" size="30" name="name"  value = "<?php echo $name; ?>" disabled>
									<textarea class = "form-control" placeholder="Enter your message." rows = "5" name = "message"></textarea>
									<input type="submit" aria-require name="submit" class="theme_button color1" value = "Send Message">
