...
<!-- </section> -->
	...
	<script type="text/javascript">
		...
		function addques(){
			i++;
			$('#formques').append('<div id="questy'+i+'" class="col-md-12"><label>Questio '+i+'</label> <br> <textarea name="question'+i+'"  style="width:75%;!important"></textarea><br><input type="radio" name="option'+i+'" value="1"><input type="text" id="e2" name="option'+i+'1"><input type="radio" name="option'+i+'" value="2"><input type="text" id="e2" name="option'+i+'2"><br><input type="radio" name="option'+i+'" style="padding-bottom: 30px;" value="3"><input type="text" id="e2" name="option'+i+'3"><input type="radio" name="option'+i+'" value="4"><input type="text" id="e2" name="option'+i+'4"><input type="button" style="width:100px; height: 40px;"  onclick="del(questy'+i+');" class="btn-danger" value="Delete"></div>');
			$('#limitno').val(i);
		}
		function del(a){
			//alert(a);
