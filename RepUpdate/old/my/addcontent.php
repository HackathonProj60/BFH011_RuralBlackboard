				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
								...
								DEPARTMENT: <select name = deanery id="departmentddl">
								<option selected value = "" disabled>Department</option> 
								</select>
								&nbsp;&nbsp;&nbsp;COURSE NAME: <select id="courseddl" onchange = "this.form.submit()">
								<option selected value = "" disabled>Course </option> 
								</select>
						
								<a href="view_content.php" target="_blank">	<button >Review</button>	</a>
