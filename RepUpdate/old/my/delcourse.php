...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <h2 class="highlight2">Delete Course</h2>
                        ...
                        <div class="row">      
                                ...
                                <div class="col-sm-12">
                                        <div class="shipping-calculator-form with_padding with_border color_border">
                                            <h3 class="topmargin_0 text-center">Delete Course</h3>
                                            <p>Fill the details below</p>
                                            <div class="form-group col-sm-6">
                                                <input type="text" class="form-control" value="" placeholder="Coursename" name="cn"> 	 
                                            </div>
  ...
  if(isset($_POST['del']))
  {
	...
	$deletekey = $_POST['cn'];
		$query=mysqli_query($connection,"delete from course where course_name = '$deletekey'");
		if($query)
			{
				...
				"<script type = 'text/javascript'>alert('Course not Deleted')</script>";
			}
