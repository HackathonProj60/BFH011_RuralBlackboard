					...
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<ul class="inline-list menu darklinks">
											...
											<form>
												...
												<div class="content-justify divider_20">
													<div class="checkbox margin_0">
														...
														<label for="topline-remember_me_checkbox" class="grey">Remember Me
														</label>
													</div>
								...
								<li>
									<a href="shop-register.html" class="small-text">Sign up</a>
								</li>
								<li>
																</ul>
						...
						<div class="col-sm-12 display_table">
							...
							<div class="header_right_buttons display_table_cell text-right hidden-xs ls">
								<ul class="inline-list menu darklinks">
									...
									<li>
										<a href="shop-register.html" class="small-text medium">Sign up</a>
									</li>
									<li>
					...
					<div class="row">
						...
						<form class="shop-register" role="form" method = "post">
							...
							<div class="col-sm-6">
								...
								<option value = "Computer Science">Life Science </option>
								<option value = "Computer Science">Commerce </option>
								<option value = "Computer Science">Management </option>
								<option value = "Computer Science">Humanities </option>
								<option value = "Computer Science">Law </option>
								</select>
							...
							<div class="col-sm-6">
								<div class="form-group validate-required" id="billing_last_name_field">
									...
									<input type="text" class="form-control " name="regno" id="billing_last_name" placeholder="" value="">
								...
								<div class="form-group validate-required validate-email" id="billing_email_field">
									...
									<input type="text" class="form-control " name="email" id="billing_email" placeholder="regno@kristujayanti.com" value="">
							...
							<div class="form-group validate-required validate-phone col-sm-6" id="phone_field">
								...
								<div class="form-group col-sm-6" id="password_field">
									...
									<input type="password" class="form-control " name="password" id="billing_password" placeholder="Greater than 8 characters" value="">
								...
								<div class="form-group col-sm-6" id="billing_password2_field">
									...
									<input type="password" class="form-control " name="password2" id="billing_password2" placeholder="Greater than 8 characters" value="">
...
<?php
	...
	if(isset($_POST['register']))
	{
		...
		$query = mysqli_query($connection,"select * from student where email='$email' or regno='$regno' or phone = '$phone'");
		if($query)
		{
			...
			{
			$query = mysqli_query($connection,"select * from existing where email='$email' and regno='$regno'"); 
			if($query)
			{
				if(mysqli_num_rows($query)>0){
					if(($password==$confirmpassword)and(strlen($password)>8)){
						...
						elseif(!(is_numeric($phone))){
								echo "<script type = 'text/javascript'>alert('inavlid phone')</script>";
						}
						...
						{
							$query = mysqli_query($connection,"insert into student values('$name','$dept','$regno','$phone','$email','$otp')");
									if($query)
									{
											$query = mysqli_query($connection,"insert into login values('$regno','$password')");
												if($query)
														{
						...
						echo"<script type = 'text/javascript'>alert('please check your password or make sure its greater than 8 characters')</script>";
					}
				}
				else
				{
					echo "<script type = 'text/javascript'>alert('Email or Regno Invalid')</script>";
				}
			}
			}
