...
//populate the data
	$query=mysqli_query($con,"select * from courses,student,enrollment where and enrollment.course_code=courses.course_code and courses.course_code='".$course_code."' and enrollment.course_code='".$course_code."' and enrollment.reg_no=student.reg_no order by reg_no");
	$row=4;
