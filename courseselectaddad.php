 ...
 <a class="nav-link" id = "showthat">
  ...
  <span>Services</span>
                                        ...
                                        <ul id = "displaythis">
                                            ...
                                            <li>
                                                <a style="color:white;" href="courseselectaddad.php">Add Notes</a>
                                            </li>
                                            <li>
                                                <a style="color:white;" href="reportadmin.php"> View Report</a>
                                            </li>
                                            <li>
...
<body>
	...
	<center><h3>SELECT COURSE</h3></center><br><br><br><br>
  <div class="container-fluid">
   <div class="row">
        <div class="col-xl-6 col-sm-6 mb-6">
            	...
            	<form method = "GET" action="teacherss.php">
                    <br>
            		<input type ="text" id = "hiddenval" name="course">
                    <br>
            		<div class="topmargin_30">
            			<input type="submit" id = "sbmt" name = "sbmt" class="theme_button color2" value = "Proceed"></input>
            		</div>
            	</form>
                <br>
                <br>
