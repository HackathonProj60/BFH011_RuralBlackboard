...
<div id="content-wrapper">
	<center><h3>DELETE USER</h3></center><br><br><br><br>
...
if(isset($_POST['del']))
{
	...
	$query=mysqli_query($con,"delete from student where reg_no = '$deletekey'");
	if($query)
	{
		...
		{
			$query=mysqli_query($con,"delete from staff where staff_id = '$deletekey'");
			if($query)
			{
				if(mysqli_affected_rows($con)>0)
				{
