...
<section class="search-section ss-other-page myc">
		<div class="container" >
			<div class="search-warp" style="background:#203c6c;">
			
				<div class="section-title text-white" style="background:#203c6c;">
					<h2><span style="background:#203c6c;">Search your course</span></h2>
				</div>
				<div class="row">
