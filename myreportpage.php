        ...
        <div class="col-xl-6 col-sm-6 mb-6">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><br><center> Course Report</center><br></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="adcoursereport.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-6">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><br><center> Student Report</center><br></div>
            </div>
		...
		<div class="col-xl-6 col-sm-6 mb-6">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><br><center> Teacher Report</center><br></div>
            </div>
		...
		<div class="col-xl-6 col-sm-6 mb-6">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><br><center> Extra Report</center><br></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
