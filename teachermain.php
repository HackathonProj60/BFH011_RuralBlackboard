...
<?php
$id = $_SESSION['staffid'];
$query = mysqli_query($con,"select staff_name from staff where staff_id = '$id'");
if($query)
{
                                ...
                                <ul class="nav menu-click">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <!-- <li>
                                                <a href="report.php">Delete Notes</a>
                                            </li> -->
                                        </ul>
                                    </li>
                                    <li>
                    ...
                    <div class="isotope_container isotope row masonry-layout columns_margin_bottom_20">
                        <div class="isotope-item col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="media-links">
                                <a href="courseselectadd.php" class="abs-link"></a>
                            </div>
                        </div>
                    </div>
                    <div class="isotope-item col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="teaser gradient_bg_color icon-background-teaser hoverable-banner before_cover text-center">
                         ...
                         <div class="media-links">
                            <a href="addcourse.php" class="abs-link"></a>
                        </div>
                    </div>
                </div>
                <div class="isotope-item col-lg-4 col-md-6 col-sm-6 col-xs-12">
