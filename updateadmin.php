...
<div id="content-wrapper">
	<center><h3>UPDATE PASSWORD</h3></center><br><br><br><br>
  <div class="container-fluid">
   <div class="row">
        <div class="col-xl-6 col-sm-6 mb-6">
<form method = "POST">
                                <div class="form-group col-sm-6">
                                    <input type="text" class="form-control" value="" placeholder="Regno" name="regno" id="regno">
                                </div>
                                ...
                                <div class="form-group col-sm-6">
                                    <input type="password" class="form-control" value="" placeholder="New Password" name="cp" id="name">
                                </div>
...
if(isset($_POST['update']))
{
    ...
    $newpwd = $_POST['cp'];
    $regno = $_POST['regno'];
   $new = password_hash( $newpwd, PASSWORD_BCRYPT);
